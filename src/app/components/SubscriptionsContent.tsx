    ...
    <div className="p-4 md:p-8 space-y-6 md:space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div className="space-y-2">
          <h1 className="text-2xl md:text-3xl font-semibold text-[#F8FAFC]">Subscription Management</h1>
        ...
        {subscriptionCards.map((card) => {
          ...
          return (
            <Card
              ...
              className="bg-[#020817] border-[#1E293B] hover:border-[#147FFF]/50 transition-all duration-200 group cursor-pointer"
            >
              <CardHeader className="space-y-4">
                ...
                <div className="space-y-1">
                  <CardTitle className="text-[#F8FAFC]">{card.title}</CardTitle>
              ...
              <CardContent>
                <Button
                  variant="ghost"
                  className="w-full justify-between text-[#147FFF] hover:bg-[#1E293B] hover:text-[#147FFF] group-hover:bg-[#1E293B]"
                  onClick={(e) => {
                    e.stopPropagation();
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        <Card className="bg-[#020817] border-[#1E293B]">
          <CardHeader className="pb-3">
            <CardDescription className="text-[#94A3B8]">Total Subscribers</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-[#F8FAFC]">2,847</div>
            <p className="text-xs text-[#21DB00] mt-1">+12.5% from last month</p>
          </CardContent>
        </Card>

        <Card className="bg-[#020817] border-[#1E293B]">
          <CardHeader className="pb-3">
            <CardDescription className="text-[#94A3B8]">Monthly Revenue</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-[#F8FAFC]">$142,580</div>
            <p className="text-xs text-[#21DB00] mt-1">+8.2% from last month</p>
          </CardContent>
        </Card>

        <Card className="bg-[#020817] border-[#1E293B]">
          <CardHeader className="pb-3 min-h-[4.5rem]">
            <CardDescription className="text-[#94A3B8]">Churn Rate</CardDescription>
          </CardHeader>
          <CardContent className="flex flex-col justify-end">
            <div className="text-2xl font-bold text-[#F8FAFC]">2.4%</div>
            <p className="text-xs text-[#21DB00] mt-1">-0.5% from last month</p>
          </CardContent>
        </Card>

        <Card className="bg-[#020817] border-[#1E293B]">
          <CardHeader className="pb-3">
            <CardDescription className="text-[#94A3B8]">Pending Installs</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-[#F8FAFC]">47</div>
            <p className="text-xs text-[#DC6300] mt-1">+3 from yesterday</p>
          </CardContent>
        </Card>
      </div>
    </div>
