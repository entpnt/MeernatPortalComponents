  ...
  return (
    <div className="p-6 bg-background min-h-screen">
      ...
      <div className="mb-6 flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-foreground mb-1">Network Operations Center</h1>
          <p className="text-sm text-muted-foreground">Real-time monitoring and control center for fiber network operations</p>
        </div>
        <DropdownMenu>
          <DropdownMenuTrigger className="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-secondary transition-colors focus:outline-none focus:ring-2 focus:ring-focus">
            <Clock className="w-4 h-4 text-muted-foreground" />
            <span className="text-sm text-foreground">Last 24h</span>
            <ChevronDown className="w-4 h-4 text-muted-foreground" />
          </DropdownMenuTrigger>
          <DropdownMenuContent align="end" className="bg-popover border-border">
            <DropdownMenuItem className="text-foreground focus:bg-secondary focus:text-foreground">Last Hour</DropdownMenuItem>
            <DropdownMenuItem className="text-foreground focus:bg-secondary focus:text-foreground">Last 6 Hours</DropdownMenuItem>
            <DropdownMenuItem className="text-foreground focus:bg-secondary focus:text-foreground">Last 24h</DropdownMenuItem>
            <DropdownMenuItem className="text-foreground focus:bg-secondary focus:text-foreground">Last 7 Days</DropdownMenuItem>
            <DropdownMenuItem className="text-foreground focus:bg-secondary focus:text-foreground">Last 30 Days</DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-6">
        ...
        <div className="bg-card border border-border rounded-lg p-4 hover:border-focus transition-colors cursor-pointer">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div className="bg-card border border-border rounded-lg p-5">
          <div className="flex items-start justify-between mb-4">
            <div>
              <h3 className="text-base font-semibold text-foreground mb-1">Network Layer Status</h3>
              <p className="text-xs text-muted-foreground">Core, aggregation, and access layers</p>
            </div>
          </div>
            ...
            <div className="p-4 bg-secondary border border-border rounded-lg">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium text-foreground">Core Layer</span>
                </div>
            ...
            <div className="p-4 bg-secondary border border-border rounded-lg">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium text-foreground">Aggregation Layer</span>
                </div>
                <span className="px-2 py-1 bg-[#DC6300]/10 text-[var(--warning)] text-xs rounded">Degraded</span>
              </div>
              <div className="flex items-center gap-6 text-xs text-muted-foreground">
            ...
            <div className="p-4 bg-secondary border border-border rounded-lg">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium text-foreground">Access Layer (OLTs)</span>
                </div>
                <span className="px-2 py-1 bg-[var(--success)]/10 text-[var(--success)] text-xs rounded">Online</span>
              </div>
              <div className="flex items-center gap-6 text-xs text-muted-foreground">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div className="bg-card border border-border rounded-lg p-5">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h3 className="text-base font-semibold text-foreground mb-1">Active Alerts</h3>
          ...
          <div className="space-y-3">
            {recentAlerts.map((alert) => (
              <div 
                key={alert.id}
                className="p-3 bg-secondary border border-border rounded-lg hover:border-[#147FFF] transition-colors cursor-pointer"
              >
                ...
                <div className="text-sm font-medium text-foreground mb-1">{alert.message}</div>
                <div className="text-xs text-muted-foreground">{alert.device}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="bg-card border border-border rounded-lg p-5 hover:border-focus transition-colors cursor-pointer">
