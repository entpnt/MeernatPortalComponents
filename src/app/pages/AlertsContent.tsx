  ...
  return (
    <div className="p-8">
        ...
        <div className="grid grid-cols-4 gap-4 mt-6">
          <div className="border border-border rounded-lg p-4">
            <div className="flex items-center justify-between">
              ...
              <Bell className="w-8 h-8 text-[#147FFF]" />
            </div>
          </div>
          <div className="border border-border rounded-lg p-4">
            <div className="flex items-center justify-between">
          ...
          <div className="border border-border rounded-lg p-4">
            <div className="flex items-center justify-between">
              ...
              <Eye className="w-8 h-8 text-[#147FFF]" />
            </div>
          </div>
        </div>
      </div>
      ...
      {selectedAlerts.size > 0 && (
        <div className="bg-[#147FFF]/10 border border-[#147FFF]/20 rounded-lg p-4 mb-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                ...
                className="bg-secondary border-border text-[var(--error)] hover:bg-secondary/80"
              >
                  ...
                  return (
                    <TableRow
                      ...
                      className={`border-b border-border hover:bg-muted/50 transition-colors cursor-pointer ${
                        !alert.isRead ? 'bg-[#147FFF]/5' : ''
                      } ${isSelected ? 'bg-[#147FFF]/10' : ''}`}
                    >
                      {/* Checkbox */}
                      ...
                      <TableCell className="py-3 px-4">
                        <div className="flex items-start gap-2">
                          {!alert.isRead && (
                            <div className="w-2 h-2 bg-[#147FFF] rounded-full mt-1.5 flex-shrink-0" />
                          )}
                          <div className="flex-1 min-w-0">
                            <p className="text-sm font-medium text-foreground mb-1">{alert.title}</p>
                            <p className="text-xs text-muted-foreground line-clamp-2">{alert.description}</p>
                            <p className="text-xs text-muted-foreground mt-1">
                              <span className="text-[#147FFF]">{alert.id}</span> • {alert.source}
                            </p>
                          </div>
                        </div>
                      </TableCell>
